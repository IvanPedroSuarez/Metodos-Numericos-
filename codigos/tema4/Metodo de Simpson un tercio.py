...
def simpson_13_interactivo():
    ...
    # Ajustar n si es impar (Simpson 1/3 requiere n par)
    if n % 2 != 0:
    ...
    try:
        ...
        # Paso 2: Generar puntos equidistantes en el intervalo [a, b]
        ...
        # Paso 7: Calcular la integral aproximada usando la fórmula de Simpson 1/3
        integral = (h / 3) * suma
    ...
    # ----------------
        ...
        # Capturar y mostrar errores durante el cálculo
...
output
=== Calculadora de Integrales por Regla de Simpson 1/3 ===
...
4. El número de subintervalos (n) debe ser par (si ingresa impar, se ajustará)

Ingrese la función a integrar (en términos de x): x**4 - 2*x + 1
Ingrese el límite inferior de integración (a): 0
Ingrese el límite superior de integración (b): 2
Ingrese el número de subintervalos (n > 0, preferiblemente par): 4

=== Resultados ===
Función integrada: f(x) = x**4 - 2*x + 1
Límites de integración: [0.0, 2.0]
Número de subintervalos usado: 4
Ancho de cada subintervalo (h): 0.500000

Valor aproximado de la integral: 2.4000000000

Detalles del cálculo:
Punto    x_i             f(x_i)          Coeficiente  Contribución    
-----------------------------------------------------------------
0        0.000000        1.000000        1            0.166667        
1        0.500000        -0.187500       4            -0.125000       
2        1.000000        0.000000        2            0.000000        
3        1.500000        2.312500        4            1.541667        
4        2.000000        9.000000        1            1.500000        

Suma ponderada de todas las contribuciones: 2.4000000000000004
